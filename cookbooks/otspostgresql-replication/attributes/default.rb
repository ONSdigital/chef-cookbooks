...
default[:postgresql][:host1]	   = "dbserv01"
default[:postgresql][:host1ip]     = "192.168.0.101"
default[:postgresql][:host2]	   = "dbserv02"
default[:postgresql][:host2ip]     = "192.168.0.102"
default[:postgresql][:status]      = "master"
default[:postgresql][:version]     = "9.2"
default[:postgresql][:port]        = "5432"
default[:postgresql][:pguser]	   = "postgres"
default[:postgresql][:bkuser]	   = "backup_user"
default[:postgresql][:repuser]     = "repl_user"
...
default[:postgresql][:wal_keep_segments]   =  "20"
